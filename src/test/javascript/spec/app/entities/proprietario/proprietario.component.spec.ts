...
describe('Component Tests', () => {
  describe('Proprietario Management Component', () => {
    ...
    it('should not load a page if the page is the same as the previous page', () => {
      // GIVEN
      proprietarioServiceStub.retrieve.reset();
      comp.previousPage = 1;
      ...
      // THEN
      expect(proprietarioServiceStub.retrieve.called).toBeFalsy();
    });
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(proprietarioServiceStub.retrieve.callCount).toEqual(3);

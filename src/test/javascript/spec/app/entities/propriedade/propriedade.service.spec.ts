...
import { Propriedade } from '@/shared/model/propriedade.model';
...
describe('Service Tests', () => {
  describe('Propriedade Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a Propriedade', async () => {
      ...
      it('should not create a Propriedade', async () => {
      ...
      it('should not update a Propriedade', async () => {
      ...
      it('should not partial update a Propriedade', async () => {
      ...
      it('should not return a list of Propriedade', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should delete a Propriedade', async () => {
      ...
      it('should not delete a Propriedade', async () => {

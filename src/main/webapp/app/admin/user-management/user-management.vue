<template>
  <div>
    ...
    <div class="table-responsive" v-if="users">
      <table class="table table-striped" aria-describedby="Usuário">
        <thead>
          <tr>
            ...
            <th scope="col"></th>
            <th scope="col"><span>Perfis</span></th>
      ...
      <b-modal ref="removeUser" id="removeUser" @ok="deleteUser()">
        <div class="modal-body">
          <p id="jhi-delete-user-heading">Você tem certeza que quer deletar esse usuário?</p>
        </div>

  ...
  <div>
      ...
      <table class="table table-striped" aria-describedby="vacinas">
        <thead>
          <tr>
            ...
            <th scope="row"><span>Data Conclusao</span></th>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="rp6App.vacina.delete.question" data-cy="vacinaDeleteDialogHeading">Confirm delete operation</span></span
      >
      <div class="modal-body">
        <p id="jhi-delete-vacina-heading">Are you sure you want to delete this Vacina?</p>
      </div>
